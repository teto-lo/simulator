    ...
    <div class="max-w-7xl mx-auto px-4 pb-20">
        ...
        <section class="mb-20">
            <div class="flex items-center gap-3 mb-8">
                ...
                <span class="px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm font-semibold">2 tools</span>
            </div>
                ...
                <a href="/compound-interest" class="group block">
                    <div
                        ...
                        <div class="p-8 relative">
                            ...
                            <h3 class="text-2xl font-bold text-gray-800 mb-3 group-hover:text-green-600 transition-colors">複利計算シミュレーター</h3>
                            <p class="text-gray-600 mb-6 leading-relaxed">投資の複利効果を可視化。元本、利率、期間を入力するだけで将来価値を計算。</p>
                            <div class="flex items-center justify-between">
                ...
                <a href="/loan-repayment" class="group block">
                    <div
                        ...
                        <div class="p-8 relative">
                            ...
                            <h3 class="text-2xl font-bold text-gray-800 mb-3 group-hover:text-emerald-600 transition-colors">ローン返済シミュレーター</h3>
                            <p class="text-gray-600 mb-6 leading-relaxed">住宅ローン・車ローンの月々の返済額と総支払額を計算。繰り上げ返済効果も確認可能。</p>
                            <div class="flex items-center justify-between">
        ...
        <section class="mb-20">
            <div class="flex items-center gap-3 mb-8">
                ...
                <span class="px-3 py-1 bg-red-100 text-red-700 rounded-full text-sm font-semibold">2 tools</span>
            </div>
                ...
                <a href="/bmi-calculator" class="group block">
                    <div
                        ...
                        <div class="p-8 relative">
                            ...
                            <h3 class="text-2xl font-bold text-gray-800 mb-3 group-hover:text-red-600 transition-colors">BMI・適正体重計算</h3>
                            <p class="text-gray-600 mb-6 leading-relaxed">身長と体重からBMI値を算出。適正体重や肥満度を判定して健康管理をサポート。</p>
                            <div class="flex items-center justify-between">
                ...
                <a href="/bmr-calculator" class="group block">
                    <div
                        ...
                        <div class="p-8 relative">
                            ...
                            <div class="mb-2">
                                <span
                                    class="inline-block px-3 py-1 bg-pink-100 text-pink-700 rounded-full text-xs font-bold mb-3">NEW</span>
                            </div>
                            <h3 class="text-2xl font-bold text-gray-800 mb-3 group-hover:text-pink-600 transition-colors">基礎代謝・消費カロリー計算</h3>
                            <p class="text-gray-600 mb-6 leading-relaxed">年齢・性別・体重から基礎代謝量を算出。活動レベル別の1日消費カロリーも計算。</p>
                            <div class="flex items-center justify-between">
